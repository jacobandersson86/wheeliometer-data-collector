...
def fuse_pose(
    ...
    still_accel_gate_g = 0.06
    still_gyro_gate_dps = 1.0
    accel_deadband_m_s2 = 0.20
    velocity_leak_tau_s = 3.0
    ...
    for sample, orientation in zip(sample_list, orientation_samples):
        ...
        linear_world_m_s2[0] = _apply_component_deadband(linear_world_m_s2[0], accel_deadband_m_s2)
        linear_world_m_s2[1] = _apply_component_deadband(linear_world_m_s2[1], accel_deadband_m_s2)
        linear_world_m_s2[2] = _apply_component_deadband(linear_world_m_s2[2], accel_deadband_m_s2)
